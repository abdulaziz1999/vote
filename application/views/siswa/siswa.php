                ...
                <tbody>
                  <?php $no=1; foreach($siswa as $row):?>
                    <tr>
                      ...
                      <td><?= $row->jk?></td>
                      <td>
                          <button type="button" class="btn btn-sm btn-info ml-1" data-toggle="modal" data-target="#edit" onclick="showSiswaEdit(<?= $row->idsiswa?>)"><i class="ni ni-ruler-pencil"></i>&nbsp; Edit</button>
                          <button type="button" class="btn btn-sm btn-danger ml-1" onclick="deleteSiswa(<?= $row->idsiswa?>)"><i class="fas fa-trash"></i>&nbsp; Delete</button>
                      </td>
                    </tr>
