            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Voting Guru</li>
                </ol>
              </nav>
            </div> 
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header text-center mb-0 mt-0">
              <h2>Form Voting untuk Guru</h2>
            </div>
            <div class="card-body">
                    <form method="POST" action="<?= base_url('voting_guru/vote_guru')?>" enctype="multipart/form-data" autocomplete="off">
                          <!-- Input groups with icon -->
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                              <label class="form-control-label" for="exampleDatepicker"> Nama Guru :</label>
