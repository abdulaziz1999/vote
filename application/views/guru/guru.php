                ...
                <tbody>
                  <?php $no=1; foreach($guru as $row):?>
                    <tr>
                      ...
                      <td><?= $row->jk?></td>
                      <td>
                          <button type="button" class="btn btn-sm btn-info ml-1" data-toggle="modal" data-target="#edit" onclick="showGuruEdit(<?= $row->idguru?>)"><i class="ni ni-ruler-pencil"></i>&nbsp; Edit</button>
                          <button type="button" class="btn btn-sm btn-danger ml-1" onclick="deleteGuru(<?= $row->idguru?>)"><i class="fas fa-trash"></i>&nbsp; Delete</button>
                      </td>
                    </tr>
